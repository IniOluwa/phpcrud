    ...
    <head>
        ...
        <?php
            ...
            if (isset($_POST['submit'])) {
                ...
                $message = "The page has successfully been updated.";
            }else{
                if (isset($errors)) {
                    # code...
    ...
    <body>
        ...
        <section>
            <div class="row">
                ...
                <h2 class="jumbotron">Edit Page: <?php echo $the_selected_page['menu_name'] ?></h2>
                <?php
                    if (isset($message)) {
                        # code...
                ...
                <div class="col-sm-5 form">
                    <form class="form-horizontal" action="edit-subject.php?subj=<?php echo urlencode($the_selected_page['id']); ?>" method="post">
                        <fieldset>
                        <legend>Edit a page</legend>
                        <div class="form-group">
                            <label for="" class="col-lg-2 control-label">Page name</label>
                            <div class="col-lg-10">
                              <input type="text" class="form-control" name="menu_name" id="" placeholder="Subject name" value="<?php echo $the_selected_page['menu_name'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <?php 
                                $num_of_pages = mysqli_num_rows(get_all_pages($id));
                                for ($count=1; $count <= $num_of_pages+1 ; $count++) { 
                                    # code...
                                    echo "<option value=\"{$count}\"";
                                    if ($the_selected_page['position'] == $count) {
                                        # code...
                                        echo " selected";
                                    }
                                    echo " >{$count}</option>";
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" name="visible" id="optionsRadios1" value="1"
                                    <?php 
                                        if ($the_selected_page['visible'] == 1) {
                                            # code...
                                            echo "checked=\"\"";
                                        }
                                    ?>
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" name="visible" id="optionsRadios2" value="0"
                                    <?php 
                                        if ($the_selected_page['visibLe'] == 0) {
                                            # code...
                                            echo "checked=\"\"";
                                        }
                                    ?>
                        ...
                        <div class="form-group">
                            <div class="col-lg-10 col-lg-offset-2">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary">Edit page</button>
                                <button type="delete" class="btn btn-danger"><a href="delete-subject.php?subj=<?php echo urlencode($the_selected_page'id']); ?>" onclick="return confirm('Are you sure?')">Delete page</a></button>
                            </div>
                        </div>
